...
describe('Service Tests', () => {
    describe('Kunde Service', () => {
        ...
        beforeEach(() => {
            ...
            elemDefault = new Kunde('ID', 'AAAAAAA', 'AAAAAAA');
        });
        ...
        describe('Service methods', async () => {
            ...
            it('should create a Kunde', async () => {
            ...
            it('should update a Kunde', async () => {
                const returnedFromService = Object.assign(
                    {
                        name: 'BBBBBB',
                        vorname: 'BBBBBB'
            ...
            it('should return a list of Kunde', async () => {
                const returnedFromService = Object.assign(
                    {
                        name: 'BBBBBB',
                        vorname: 'BBBBBB'
            ...
            it('should delete a Kunde', async () => {
