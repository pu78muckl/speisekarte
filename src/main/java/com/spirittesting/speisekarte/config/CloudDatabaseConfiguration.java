package com.spirittesting.speisekarte.config;
...
@Configuration
@EnableMongoRepositories("com.spirittesting.speisekarte.repository")
...
public class CloudDatabaseConfiguration extends AbstractCloudConfig {
    ...
    public Mongobee mongobee(MongoDbFactory mongoDbFactory, MongoTemplate mongoTemplate, Cloud cloud) {
        ...
        mongobee.setChangeLogsScanPackage("com.spirittesting.speisekarte.config.dbmigrations");
